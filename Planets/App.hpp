...
public:
	...
	void processInput() {
		...
		case CMD_REMOTE_COMMAND:
		{
			//needed in case no gameobjects exist
	...
	void Init(char* path) {
		...
		auto m0 = rm.loadAlxModel((char*) "sphere.alx", (char*) "mercury.tga", 0, size[0]*sc);
		auto m1 = rm.loadAlxModel((char*) "sphere.alx", (char*) "venus.tga", 1, size[1]*sc);
		auto m2 = rm.loadAlxModel((char*)"sphere.alx", (char*) "earth.tga", 2, size[2]*sc);
		auto m3 = rm.loadAlxModel((char*) "sphere.alx", (char*) "mars.tga", 3, size[3]*sc);
